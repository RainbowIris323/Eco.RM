...
public class RMObjectResolver : AutoSingleton<RMObjectResolver>
{
    ...
    {
        if (DefaultObjectModels.SingleOrDefault(x => x.Name == objectName) != null) { LogUtililty.Warn($"An object with the same name of '{objectName}' has allready been assigned defaults within 'RMObjectResolver.DefaultObjectConfigs'"); return; }
